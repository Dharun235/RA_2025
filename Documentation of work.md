...
# **28/08/2025**  
- Worked from 9-17.
- Web scraping of all the pepper related documents is updated, and the file is uploaded with detailed readme, html files, softwares, and basic knowledge text.
- Docker was evaluated and not running in windows, but only ubuntu.
---
